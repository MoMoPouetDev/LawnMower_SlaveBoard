...
{
	CYCLIC_TASK_GPS_ACQUISITION | CYCLIC_TASK_SONAR,// 0
	CYCLIC_TASK_GPS_ACQUISITION | CYCLIC_TASK_SONAR | CYCLIC_TASK_ADC_READ_VALUE,  // 1
	CYCLIC_TASK_GPS_ACQUISITION | CYCLIC_TASK_SONAR | CYCLIC_TASK_UPDATE_LED, // 2
	CYCLIC_TASK_GPS_ACQUISITION | CYCLIC_TASK_SONAR | CYCLIC_TASK_ADC_READ_VALUE, // 3
	CYCLIC_TASK_GPS_ACQUISITION | CYCLIC_TASK_SONAR, // 4
	CYCLIC_TASK_GPS_ACQUISITION | CYCLIC_TASK_SONAR | CYCLIC_TASK_ADC_READ_VALUE,  // 5
	CYCLIC_TASK_GPS_ACQUISITION | CYCLIC_TASK_SONAR,  // 6
	CYCLIC_TASK_GPS_ACQUISITION | CYCLIC_TASK_SONAR | CYCLIC_TASK_ADC_READ_VALUE,  // 7
	CYCLIC_TASK_GPS_ACQUISITION | CYCLIC_TASK_SONAR,  // 8
	CYCLIC_TASK_GPS_ACQUISITION | CYCLIC_TASK_SONAR | CYCLIC_TASK_ADC_READ_VALUE,  // 9
};
